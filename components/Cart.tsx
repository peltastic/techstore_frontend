...
function Cart(props: Props) {
  ...
  return (
    <div className=" flex items-end mb-10">
      <div className="relative mr-8 w-[20rem] h-[20rem] bg-gradient-to-br from-[#cacaca] to-[#ebebeb]">
      ...
      <div className="">
        <div className="flex py-4">
          <Button content={<MdAdd />} class=" text-3xl text-black" />
          <Button content={<AiOutlineMinus />} class="text-3xl text-black" />
        </div>
        <p className="py-4 text-xl">15</p>
        <h1 className="font-bold py-4">HeadPhone</h1>
        <p className="font-bold text-2xl py-4">$999</p>
      </div>
    </div>
    // <div
