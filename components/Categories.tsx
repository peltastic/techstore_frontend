...
const Categories = (props: Props) => {
  return (
    <section className="flex flex-wrap bp2:flex-nowrap w-full">
      <div className="w-[100%] bp2:w-[50%] mt-10 flex flex-wrap mr-4">
        <div className="w-full flex mb-8">
          <div className="relative text-white bp2:mr-4 w-[51%] bp2:w-[48%] bg-gradient-to-br from-[#000000] to-[#3b3b3b] rounded-3xl h-[30rem]">
      ...
      <div className=" w-[100%] bp2:w-[50%] mt-10 flex flex-wrap ml-4">
        <div className="text-white relative w-full mb-8 bg-gradient-to-br from-[#d20303] to-[#ea4444] rounded-3xl h-[30rem]">
          ...
          <div className="absolute left-[3rem] bp1:left-[8rem] bottom-[3rem]">
        ...
        <div className="w-full flex">
          <div className="relative text-white bp2:mr-4 w-[51%] bp2:w-[48%] bg-gradient-to-br  from-[#03c806] to-[#03ab069f] rounded-3xl h-[30rem]">
