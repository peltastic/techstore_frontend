...
function ProductOps(props: Props) {
  return (
    <div className="flex w-full h-screen ">
      <div
        className={`${props.class_left} ml-[5rem] mr-[-6rem] relative w-[50%] h-[70vh] border border-[#B3541E] my-auto`}
      >
      ...
      <div
        className={`${props.class_right} relative mr-[5rem] ml-[-6rem] w-[50%] h-[70vh] border border-[#B3541E] my-auto`}
      >
