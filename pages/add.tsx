          ...
          <div className="text-white w-[40%] mx-auto px-[2rem] ">
            ...
            <div className="flex items-center  w-full mb-[2rem]">
              ...
              <div className="w-[50%] flex justify-center  ">
                <div className={`mx-auto items-center border flex px-[2rem] ${productData.imageFile ? "bg-[#B3541E]": null}`}>
                  <input
                    type="file"
                    className={`${classes.FileInput} ${productData.imageFile ? "text-white":"text-[#B3541E]"}  mx-auto`}
                    onChange={onChangeFile}
                    accept="image/png, image/jpeg"
                  />
                  {!productData.imageFile ? <IoAddSharp className="text-3xl text-[#B3541E]" /> : <IoMdCheckmark className="text-3xl text-white"/>}
                </div>
              </div>
            </div>
          </div>
